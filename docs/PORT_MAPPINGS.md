...
- **Relay Server API**: http://localhost:8080/api/config
...
- The container currently running uses the old image where IPFS gateway is still on 8080, but it's mapped to external
  port 8082
